...
figure;
plot(u_s_ref_lim.Time, real(u_s_ref_lim.Data)); hold on;
yline(real(u_s));
...
figure;
plot(u_s_ref_lim.Time, imag(u_s_ref_lim.Data)); hold on;
yline(imag(u_s));
...
figure;
plot(i_s_ref.Time, real(i_s_ref.Data)); hold on;
yline(i_d);
...
figure;
plot(i_s_ref.Time, imag(i_s_ref.Data)); hold on;
yline(i_q);
